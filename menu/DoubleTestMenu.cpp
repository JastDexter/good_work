...
Menu *DoubleTestMenu::result(std::string input) {
    try {
        ...
        switch (choice) {
            ...
            case 9: {
                ...
                std::cin >> input;
                double about = std::stod(input);
                auto temp = list->find([](double data, double about) -> bool {
                    return data == about;
                }, about);
